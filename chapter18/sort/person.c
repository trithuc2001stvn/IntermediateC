...
PersonDatabase * Person_read(char * filename)
{
	...
	int numPerson = 0;
	int longestName = 0;
	// longest name, length of buffer to read names
	while (! feof(fptr))
	{
		int age;
	...
	int ind = 0;
	// read the fiel again and store the data in the database
	// return of the begining of the file
...
void Person_print(PersonDatabase * perdb)
{
	...
	// stdout: output is sent to the computer screen,
