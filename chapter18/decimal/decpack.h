...
// Insert a deciaml value into the DecPack object. The new
...
// The return value should be between 0 and 9
// return -11 if no digit can be deleted
int DecPack_delete(DecPack * dp);
// print the values stored in the object, the first inserted
// value should be printed first
// the printed value are between 0 and 9
